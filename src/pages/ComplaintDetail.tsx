...
import { ArrowLeft, AlertCircle, Phone, Mail, Building2, Calendar, Loader2, Edit } from 'lucide-react';
    ...
    return (
      <DashboardLayout>
        <div className="flex items-center justify-center min-h-[400px]">
          ...
          <span className="ml-3 text-gray-600 dark:text-gray-400 font-medium">Loading complaint...</span>
        </div>
      </DashboardLayout>
    );
  }
    ...
    <DashboardLayout>
      <div className="space-y-6">
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50">
            <CardHeader>
              <CardTitle className="flex items-center space-x-2">
                ...
                <span>Complainer Information</span>
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label className="text-sm font-medium text-gray-500 dark:text-gray-400">Complainer Name</Label>
                <p className="text-lg font-semibold text-gray-900 dark:text-gray-100">{complaint.complainer_name}</p>
              </div>
              ...
              {complaint.phone_number && (
                <div className="space-y-2">
                  ...
                  <p className="text-base text-gray-900 dark:text-gray-100">{complaint.phone_number}</p>
                </div>
              )}
              ...
              {complaint.email && (
                <div className="space-y-2">
                  ...
                  <p className="text-base text-gray-900 dark:text-gray-100">{complaint.email}</p>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-base text-gray-900 dark:text-gray-100">{formatDate(complaint.complaint_date)}</p>
              </div>

              <div className="space-y-2">
                <Label className="text-sm font-medium text-gray-500 dark:text-gray-400">Created At</Label>
                <p className="text-sm text-gray-600 dark:text-gray-400">{formatDate(complaint.created_at)}</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-gray-50/50 dark:from-gray-900 dark:to-gray-800/50">
          ...
          <CardContent>
            <div className="space-y-2">
              <Label className="text-sm font-medium text-gray-500 dark:text-gray-400">Complaint Text</Label>
