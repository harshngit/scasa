...
export default function CreateDepositeOnRenovation() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error creating deposit:', error);
      toast.dismiss();
      toast.error(error.message || 'Failed to create deposit. Please try again.');
    } finally {
          ...
          <div className="relative z-10 flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Add a new renovation deposit with complete details
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex justify-end gap-4 pt-4">
            <Button 
              type="button" 
              variant="outline" 
              onClick={() => navigate('/expenses/deposite-on-renovation')}
