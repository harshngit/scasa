...
export default function CreatePermission() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const loadingToast = toast.loading('Creating permission...');
    ...
    try {
      ...
      // Navigate back to permissions page after successful creation
      setTimeout(() => {
          ...
          <div className="relative z-10 flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Add a new permission with complete details
              </p>
            </div>
          </div>
        </div>
